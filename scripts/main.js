;(function (window) {
  ...
  let texts = ['SHRAMITTAAA', 'THANKK YOUU' , 'FOR','EVERYTHING', 'LIKE', 'EVERYTHINGG', 'IM', 'GRATEFUL', 'TO HAVE ', 'YOU IN ', 'MY LIFE', 'AND YEAA', 'HAPPY',  'VALENTINE\'S', 'DAY', 'I HOPE WE' , 'WILL', 'BE CLOSER',  'AND', 'CLOSER AS' ,'TIME', 'GOES ON', 'TAKECAREEKIDDO']
